#' Shootings in the Bronx in 2019
#'
#' Dataset of shootings in the Bronx borough of New York City recorded by the
#' New York City Police Department (NYPD) in 2019.
#'
#' @format A data frame with 267 rows and five columns:
#' \describe{
